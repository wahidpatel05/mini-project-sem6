  ...
  return (
    ...
    >
          ...
          <div className="flex flex-wrap gap-2">
            {data.attachments.map((attachment, index) => (
              <a
                ...
                className="flex items-center gap-1 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200 rounded px-2 py-1 text-xs transition"
              >
                ...
                <span className="truncate max-w-[150px] text-indigo-700">
                  {attachment.fileName}
                </span>
              </a>
            ))}
      ...
      <div className="mt-5 space-y-2">
        ...
        <p className="text-xs text-gray-500 text-center">Upload proof files when completing</p>
